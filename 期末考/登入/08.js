...
function visitor() {
	...
	var title_text = document.createTextNode("大標題(POS)"); //新建一个文本节点
	...
	var content_text1 = document.createTextNode("這是一筆測試內容");
	var content_text2 = document.createTextNode("這是一筆測試內容");
	var content_text3 = document.createTextNode("這是一筆測試內容");
	var content_text4 = document.createTextNode("這是一筆測試內容"); //添加内容
